<template>
  <main class="flex h-screen w-full items-center justify-center bg-gray-100">
    <form
      ...
      @submit.prevent="authStore.createUser()"
    >
      <h5 class="font-bold text-xl">Registration</h5>
      <div class="mt-5 flex flex-col">
        <span class="font-semibold">Email</span>
        <input
          v-model="authStore.userRegistration.email"
          type="email"
          name=""
          id=""
      ...
      <div class="mt-4 flex flex-col">
        ...
        <input
          v-model="authStore.userRegistration.name"
          type="text"
          name=""
          id=""
          class="border border-gray-400 rounded-md px-3 py-2 w-full mt-1"
      ...
      <div class="mt-4 flex flex-col">
        ...
        <div class="relative flex items-center justify-center">
          <input
            v-model="authStore.userRegistration.password"
      ...
      <div class="mt-4 flex flex-col">
        <span class="font-semibold">Password Confirmation</span>
        <div class="relative flex items-center justify-center">
          <input
            v-model="authStore.userRegistration.password_confirmation"
            :type="isHidden ? 'text' : 'password'"
            class="border border-gray-400 rounded-md px-3 py-2 w-full mt-1"
      ...
      <button
        type="submit"
        class="w-full py-2 bg-blue-500 rounded-md mt-4 font-semibold text-white hover:bg-blue-600 transition-all"
      >
        Login
      </button>
      <p class="mt-2 text-right font-semibold text-sm cursor-pointer">
